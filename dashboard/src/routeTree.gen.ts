...
const DashboardRealityLazyRoute = DashboardRealityLazyImport.update({
  id: '/reality',
  path: '/reality',
  getParentRoute: () => DashboardRoute,
} as any).lazy(() =>
...
const DashboardHealthLazyRoute = DashboardHealthLazyImport.update({
  id: '/health',
  path: '/health',
  getParentRoute: () => DashboardRoute,
} as any).lazy(() =>
...
const DashboardBillingInvoicesLazyRoute =
  DashboardBillingInvoicesLazyImport.update({
    ...
    import('./routes/_dashboard/billing.invoices.lazy').then((d) => d.Route),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_dashboard/health': {
      ...
      path: '/health'
      fullPath: '/health'
      preLoaderRoute: typeof DashboardHealthLazyImport
      parentRoute: typeof DashboardImport
    }
    '/_dashboard/hosts': {
      id: '/_dashboard/hosts'
    ...
    '/_dashboard/billing/invoices': {
      id: '/_dashboard/billing/invoices'
      path: '/billing/invoices'
